...
\begin{figure}[H]
\centering
\includegraphics[width=1.0\textwidth]{plots/trends/trend_r2_vs_underwater.png}
\caption{Trend: Pricing Correlation vs.  Negative Equity}
\end{figure}
...
The ``Super-Prime'' branding of the P-Series presents material challenges for
investors seeking accurate assessments of Probability of Default (PD) and Loss
Given Default (LGD). While the issuer appears to have captured subprime-like
yields through high LTV/PTI structures and pricing flexibility, it has provided
investors with the transparency and risk profile traditionally associated with
prime ABS. This constitutes \textbf{risk arbitrage through disclosure
asymmetry}.
