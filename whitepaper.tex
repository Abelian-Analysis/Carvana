...
\title{
    \vspace{1in}
    \Huge \textbf{\textcolor{navyblue}{The Divergence of Prime Metrics:}} \\
    \Large \textbf{\textcolor{navyblue}{Systemic Data Patterns and Structural 
    Risk in Carvana P-Series Auto ABS}} \\
    \vspace{0.2in}
    \Large \textit{\textcolor{darkgray}{Formal Analysis regarding Carvana Auto 
...
\end{figure}
The breakdown in $R^2$ correlates precisely with a marked increase in high-APR
loans assigned to "Prime" borrowers. Charging a 12\%+ interest rate to a
borrower with a 740+ FICO score is an implicit admission by the lender that the
FICO score is no longer a reliable indicator of the Probability of Default (PD).



\textbf{Risk Profile Analysis:}
By labeling these as "Prime" assets, the issuer captures the yield of a subprime
loan (12\%+) while benefiting from the lower capital requirements and higher
investor confidence associated with Prime ABS. This creates a \textbf{potential
mispricing of risk}, as the "Prime" designation fails to capture the true
fragility of borrowers who are high-score but low-liquidity in a high-inflation,
negative-equity environment.

\section{Impact on Investors}
The "Super-Prime" branding presents challenges for investors regarding the "Probability of 
Default" (PD) and "Loss Given Default" (LGD). The issuer is capturing 
"Subprime Yield" (high interest/fees from high LTV/PTI) while providing "Prime 
Transparency" to investors. This is known as \textbf{"Risk Arbitrage through 
Disclosure Asymmetry."}

\subsection{The "Underwater" Collateral Crisis}
...
\subsubsection{The Mechanism: Amortization vs. Depreciation}
\begin{figure}[H]
    \centering
...
\subsubsection{The Resultant Equity Gap}
